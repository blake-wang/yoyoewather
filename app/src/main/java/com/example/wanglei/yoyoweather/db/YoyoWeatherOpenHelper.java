 ...
 */
public class YoyoWeatherOpenHelper extends SQLiteOpenHelper {
    /*
    Province表建表语句
     */
    ...
    public YoyoWeatherOpenHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
